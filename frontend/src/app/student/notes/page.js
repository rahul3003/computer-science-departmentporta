      ...
      <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-300">
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-slate-500 text-xs font-semibold">{note.semester}</span>
                </div>
                <h3 className="text-[#2d1b18] font-bold text-sm leading-snug">{note.title}</h3>
                <p className="text-slate-400 text-[10px] font-semibold">File Size: {note.size} • PDF Document</p>
              </div>
        ...
        {filteredNotes.length === 0 && (
          <div className="text-center py-16 bg-[#faf7f2] border border-[#ede6dc] rounded-2xl text-slate-500 max-w-md mx-auto">
            ...
            <p className="text-sm">No notes files found matching your parameters.</p>
          </div>
        )}
